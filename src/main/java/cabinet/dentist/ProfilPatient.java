...
public class ProfilPatient implements Initializable {
    ...
    public void switching(ActionEvent event, String file_name, int width, int length, boolean sameStage) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource(file_name));
        Stage stage;
        if(sameStage) stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
    ...
    public void back(ActionEvent event) throws IOException {
        switching(event,"Patient_List.fxml",1024,700,true);
    }

    public void overview(ActionEvent event) throws IOException {
        switching(event,"acceuil.fxml",766,600,true);
    }
    public void logout(ActionEvent event) throws IOException {
        switching(event,"authentification.fxml",1024,700,true);
    }

    public void ADD_ActMed(ActionEvent event) throws IOException {
        switching(event,"ADD_ActeMed.fxml",468,458,false);
    }
}
